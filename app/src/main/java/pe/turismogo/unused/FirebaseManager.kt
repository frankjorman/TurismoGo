...
@Deprecated("Esta clase está obsoleta. Utiliza DatabaseManager en su lugar DatabaseManager.", ReplaceWith("DatabaseManager"))
open class FirebaseManager : DatabaseObservable.UserDataObservable, DatabaseObservable.UserUpdateObservable, AuthObserver.AuthSession, AuthObserver.AuthUser {
    ...
    private val userObserverList : ArrayList<DatabaseObserver> = arrayListOf()
...
//        }
    ...
    override fun addUserDataObservable(observer: DatabaseObserver.UserDataObserver) {
        TODO("Not yet implemented")
    }

    override fun removeUserDataObservable(observer: DatabaseObserver.UserDataObserver) {
        TODO("Not yet implemented")
    }
